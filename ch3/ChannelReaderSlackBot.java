...
public class ChannelReaderSlackBot {
	...
	private static final String SLACK_BOT_TOKEN = "TON_TOKEN_API_SLACK";

	public static void main(String[] args) {
    	Slack slack = Slack.getInstance();
    	MethodsClient methods = slack.methods(SLACK_BOT_TOKEN);

    	String channelId = "TON_ID_DE_CHANNEL";
        	...
        	if (response != null && response.isOk()) {
            	...
            	for (Message message : messages) {
                	...
                	if (userInfoResponse != null && userInfoResponse.isOk()) {
                    	...
                    	System.out.println("Horodatage: " + timestamp);
                    	System.out.println("Message: " + message.getText());
                    	System.out.println();
                	}
            	}
        	} else {
            	System.out.println("Échec de la récupération des messages: " + response.getError());
        	}
    	} catch (Exception e) {
        	e.printStackTrace();
    	}
