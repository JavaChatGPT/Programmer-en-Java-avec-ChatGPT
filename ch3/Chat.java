...
public class Chat {
    ...
    public static ChatBuilder builder() {
        ...
        // nous avons besoin d'un message par défaut ici pour éviter les erreurs 400 de l'API
        List<Message> messages = new ArrayList<>();
        messages.add(new Message("system", "Tu es un assistant utile"));
        messages.add(new Message("user", "Bonjour"));
